...
if (ToolBar_Supported)
{
	...
	if (!RTL){
		...
		HTMLStr += "<DIV ID='idSpace1'		STYLE='position:absolute;top:0px;left:250px;height:20px;vertical-align:top;overflow:hidden;background-color:#003399;'><img src='/library/images/support/1ptrans.gif'></DIV>"
		...
		HTMLStr += "<DIV ID='idMSMenuPane'  STYLE='position:absolute;top:0px;left:250px;height:20px;width:10px;background-color:black;float:right;' ALIGN=RIGHT NOWRAP><!--MS_MENU_TITLES--></DIV>";
		HTMLStr += "</DIV>";
	}else if(RTL){
		...
		HTMLStr += "<DIV ID='idSpace1'		STYLE='position:relative;top:0px;width:100%;left:0;height:20px;vertical-align:top;overflow:hidden;z-index:-1;background-color:#003399;'><img src='/library/images/support/1ptrans.gif'></DIV>"
	...
	if(!RTL){
		...
		//This following line inserted by the GSSDEV
		HTMLStr += "<DIV ID='idSpace2'		STYLE='position:absolute;top:0px;left:0px;height:40px;vertical-align:top;overflow:hidden;background-color:#3366CC;'><img src='/library/images/support/1ptrans.gif'></DIV>"
	...
	ToolbarBGColor	= "#3366CC";						// toolbar background color
...
function resizeToolbar()
{
	...
	if ( !RTL )
	{
		...
		{	
			...
			var SpaceWidth = w;
			idSpace1.style.width =	SpaceWidth + 'px';
			idSpace2.style.width =	Math.max(realWidth, MSMenuWidth) - MSMenuWidth + 'px';
